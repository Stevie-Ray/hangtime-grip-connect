...
import type { IWHC06 } from "@hangtime/grip-connect/src/interfaces/device/wh-c06.interface"
  ...
  override connect = async (
    ...
    try {
      ...
      const optionalManufacturerData = this.filters.flatMap(
        // @ts-expect-error manufacturerData is not available in RequestBleDeviceOptions
